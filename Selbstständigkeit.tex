...
\subsubsection{Erklärung bzgl. Einsatz von IT-/KI- gestützte Schreibwerkzeuge :}

\textbf{Erklärung}

Hiermit versichere ich, dass die vorliegende Arbeit mit dem Titel \textit{Implementierung und Optimierung einer Large Language Model Agentenstruktur} selbständig von mir und ohne fremde Hilfe verfasst worden ist, dass keine anderen Quellen und Hilfsmittel als die angegebenen benutzt worden sind und dass die Stellen der Arbeit, die anderen Werken - auch elektronischen Medien - dem Wortlaut oder Sinn nach entnommen wurden, durchgängig unter Angabe der Quelle kenntlich gemacht worden sind. Dies gilt auch für Zeichnungen, Skizzen, bildliche Darstellungen und dergleichen.

Ich erkläre hiermit, dass ich beim Einsatz von IT-/Kl-gestützten Schreibwerkzeugen diese Werkzeuge unter der Rubrik \textit{Übersicht verwendeter Hilfsmittel} (\ref{sec:hilfsmittel}) mit ihrem Produktnamen, meiner Bezugsquelle und einer Übersicht des im Rahmen dieser Arbeit genutzten Funktionsumfangs vollständig aufgeführt habe. Die mit IT-/Kl-gestützten Schreibwerkzeugen erstellten Inhalte habe ich steuernd bearbeitet.
...
Ich bin hiermit einverstanden, dass von meiner Abschlussarbeit (ggf. nach Ablauf der Sperre)
