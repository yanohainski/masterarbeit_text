...
\newunicodechar{ }{~}                                       % inputencoding [eingabecodierung, enthält z.B. ß,ö,ä,...]
...
\author{Yan Ohainski} 
\title{Entwicklung eines KI-basierten Meetingassistenten zur Darstellung und Aufbereitung gesprochener Inhalte}
